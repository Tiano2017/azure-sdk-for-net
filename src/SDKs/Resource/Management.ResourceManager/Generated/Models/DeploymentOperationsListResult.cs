...
namespace Microsoft.Azure.Management.ResourceManager.Models
{
    ...
    public partial class DeploymentOperationsListResult
    {
        ...
        /// results.</param>
        public DeploymentOperationsListResult(IList<DeploymentOperation> value = default(IList<DeploymentOperation>), string nextLink = default(string))
        {
            Value = value;
            NextLink = nextLink;
            CustomInit();
        ...
        /// <summary>
        /// Gets or sets an array of deployment operations.
        /// </summary>
