...
namespace Microsoft.Azure.Management.ResourceManager.Models
{
    ...
    public partial class ManagementGroupInfo
    {
        ...
        /// group.</param>
        public ManagementGroupInfo(string id = default(string), string type = default(string), System.Guid? name = default(System.Guid?), System.Guid? tenantId = default(System.Guid?), string displayName = default(string))
        {
            Id = id;
            Type = type;
            Name = name;
