...
namespace Microsoft.Azure.Management.ResourceManager.Models
{
    ...
    public partial class ManagementGroupWithHierarchy
    {
        /// <summary>
        /// Initializes a new instance of the ManagementGroupWithHierarchy
        /// class.
        /// </summary>
        ...
        public ManagementGroupWithHierarchy(string id = default(string), string type = default(string), System.Guid? name = default(System.Guid?), System.Guid? tenantId = default(System.Guid?), string displayName = default(string), ManagementGroupDetailsProperties details = default(ManagementGroupDetailsProperties), IList<ManagementGroupRecursiveChildInfo> children = default(IList<ManagementGroupRecursiveChildInfo>))
        {
            Id = id;
            Type = type;
            Name = name;
