...
namespace Microsoft.Azure.Management.ResourceManager.Models
{
    ...
    public partial class ManagementGroupWithChildren
    {
        /// <summary>
        /// Initializes a new instance of the ManagementGroupWithChildren
        /// class.
        /// </summary>
        public ManagementGroupWithChildren()
        {
            CustomInit();
        }
        ...
        public ManagementGroupWithChildren(string id = default(string), string type = default(string), System.Guid? name = default(System.Guid?), System.Guid? tenantId = default(System.Guid?), string displayName = default(string), ManagementGroupDetailsProperties details = default(ManagementGroupDetailsProperties), IList<ManagementGroupChildInfo> children = default(IList<ManagementGroupChildInfo>))
        {
            Id = id;
            Type = type;
            Name = name;
